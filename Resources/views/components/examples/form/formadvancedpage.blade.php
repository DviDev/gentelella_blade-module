...
<head>
    ...
    <link href="{{asset('assets/modules/gentelella/vendor/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css')}}" rel="stylesheet">
    <!-- Ion.RangeSlider -->
    <link href="{{asset('assets/modules/gentelella/vendor/normalize-css/normalize.css')}}" rel="stylesheet">
    <link href="{{asset('assets/modules/gentelella/vendor/ion.rangeSlider/css/ion.rangeSlider.css')}}" rel="stylesheet">
    <link href="{{asset('assets/modules/gentelella/vendor/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css')}}" rel="stylesheet">
    <!-- Bootstrap Colorpicker -->
    <link href="{{asset('assets/modules/gentelella/vendor/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')}}" rel="stylesheet">

    <link href="{{asset('assets/modules/gentelella/vendor/cropper/dist/cropper.min.css')}}" rel="stylesheet">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="img-container">
                                        <img id="image" src="{{asset('assets/modules/gentelella/images/cropper.jpg')}}" alt="Picture">
                                    </div>
                                </div>
                                <div class="col-md-3">
...
<!-- bootstrap-datetimepicker -->
<script src="{{asset('assets/modules/gentelella/vendor/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}"></script>
<!-- Ion.RangeSlider -->
<script src="{{asset('assets/modules/gentelella/vendor/ion.rangeSlider/js/ion.rangeSlider.min.js')}}"></script>
<!-- Bootstrap Colorpicker -->
<script src="{{asset('assets/modules/gentelella/vendor/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')}}"></script>
<!-- jquery.inputmask -->
<script src="{{asset('assets/modules/gentelella/vendor/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js')}}"></script>
<!-- jQuery Knob -->
<script src="{{asset('assets/modules/gentelella/vendor/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- Cropper -->
<script src="{{asset('assets/modules/gentelella/vendor/cropper/dist/cropper.min.js')}}"></script>
