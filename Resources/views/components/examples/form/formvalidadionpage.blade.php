                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form class="" action="" method="post" novalidate>
                                    <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="{{route('gentelella.example.form.general')}}">form page</a>
                                    </p>
...
<script src="{{asset('assets/modules/gentelella/vendor/validator/multifield.js')}}"></script>
<script src="{{asset('assets/modules/gentelella/vendor/validator/validator.js')}}"></script>
