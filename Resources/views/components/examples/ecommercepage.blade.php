                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-7 col-sm-7 ">
                            <div class="product-image">
                                <img src="{{asset('assets/modules/gentelella/images/prod-1.jpg')}}" alt="..." />
                            </div>
                            <div class="product_gallery">
                                <a>
                                    <img src="{{asset('assets/modules/gentelella/images/prod-2.jpg')}}" alt="..." />
                                </a>
                                <a>
                                    <img src="{{asset('assets/modules/gentelella/images/prod-3.jpg')}}" alt="..." />
                                </a>
                                <a>
                                    <img src="{{asset('assets/modules/gentelella/images/prod-4.jpg')}}" alt="..." />
                                </a>
                                <a>
                                    <img src="{{asset('assets/modules/gentelella/images/prod-5.jpg')}}" alt="..." />
                                </a>
                            </div>
                        </div>
