...
<x-gentelella::layout.v1>
    ...
    <div class="row" style="display: inline-block;">
        <div class="tile_count">
            <x-gentelella::widget.indicator.tile value="2500">
                <x-slot:title><i class="fa fa-user"></i> Total Users</x-slot:title>
                <x-slot:footer><i class="green">4% </i> From last Week</x-slot:footer>
            </x-gentelella::widget.indicator.tile>
            <x-gentelella::widget.indicator.tile value="123.50">
                <x-slot:title><i class="fa fa-clock-o"></i> Average Time</x-slot:title>
                <x-slot:footer>
            ...
            <x-gentelella::widget.indicator.tile>
                <x-slot:title><i class="fa fa-user"></i> Total Males</x-slot:title>
                <x-slot:value class="count green">2,500</x-slot:value>
                <x-slot:footer>
                    <i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week
                </x-slot:footer>
            </x-gentelella::widget.indicator.tile>

            <x-gentelella::widget.indicator.tile value="4,567">
                <x-slot:title><i class="fa fa-user"></i> Total Females</x-slot:title>
                <x-slot:footer>
                    <i class="red"><i class="fa fa-sort-desc"></i>12% </i> From last Week
                </x-slot:footer>
            </x-gentelella::widget.indicator.tile>

            <x-gentelella::widget.indicator.tile value="2,315">
                <x-slot:title><i class="fa fa-user"></i> Total Collections</x-slot:title>
                <x-slot:footer>
                    <i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week
                </x-slot:footer>
            </x-gentelella::widget.indicator.tile>

            <x-gentelella::widget.indicator.tile value="7,325">
                <x-slot:title><i class="fa fa-user"></i> Total Collections</x-slot:title>
                <x-slot:footer>
                    <i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week
                </x-slot:footer>
